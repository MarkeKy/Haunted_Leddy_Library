...
public class Library {
    ...
    protected static List<TransformGroup> doors = new ArrayList<>(); // Added to track doors
    ...
    private static TransformGroup duplicateBooksZAxis(int numBooks, float spacing) {
        ...
        for (int i = 0; i < numBooks; i++) {
            String texture = textures.get(i % textures.size()); // Use modulo to cycle textures
    ...
    protected static TransformGroup create_Library() {
        ...
        System.out.println("Creating Library scene..."); // Debug
        ...
        // Configure second door (object3D[7])
        ...
        // Add doors to the left wall and track them
        ...
        doors.add(door1TG); // Add to doors list
        ...
        doors.add(door2TG); // Add to doors list
        ...
        Offset4.setTranslation(new Vector3f(0.86f, 0.0f, 0.1f));
        TransformGroup handleLeftTG = new TransformGroup();
        handleLeftTG.setTransform(Offset4);
        ...
        ghostTransform.setTranslation(new Vector3f(1f, -2f, 0f)); // Near the door
        ...
        object3D[7].add_Child(handleRightTG);
        ...
        libraryTG.addChild(ghostTG); // Add the ghost to the scene

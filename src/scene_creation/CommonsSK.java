...
public class CommonsSK extends JPanel {
    ...
    public static Material set_Material(Color3f m_clr) {
        ...
        Color3f dimAmbient = new Color3f(White.x * 0.3f, White.y * 0.3f, White.z * 0.3f);
        Color3f dimDiffuse = new Color3f(m_clr.x * 0.3f, m_clr.y * 0.3f, m_clr.z * 0.3f);
        Color3f dimSpecular = new Color3f(Grey.x * 0.3f, Grey.y * 0.3f, Grey.z * 0.3f);
        mtl.setAmbientColor(dimAmbient);
    ...
    public CommonsSK(BranchGroup sceneBG) {

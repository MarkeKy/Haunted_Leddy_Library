...
class WallObject extends Objects {
	public WallObject(String texture_name) {                 // Filename for the object
		...
		scale = 5.5d;                                      // actual scale is 0.3 = 1.0 x 0.3
		post = new Vector3f(0.1f, 0.9f, -4.09f);        // Define the location of the wall object
...
class PillarObject extends Objects {
	public PillarObject(String texture_name) {               // Filename for the object
		...
		transform_Object("PlanePillar", 2f);       // set transformation to 'objTG' and load object file
	}

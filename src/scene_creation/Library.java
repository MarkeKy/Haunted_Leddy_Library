...
public class Library {
    ...
    protected static TransformGroup create_Library(Map<String, Boolean> bookshelfUsage) {
        ...
        object3D[2] = new SquareShape("Capture2.JPG", 6f, 4f, 0.9f, 1f);
        ...
        object3D[15] = new PillarObject("BrickPillar.jpg");
        object3D[16] = new PillarObject("BrickPillar.jpg");
        ...
        // pillar 1
        Transform3D Offset7 = new Transform3D();
        Offset7.setTranslation(new Vector3f(2.5f, 0f, -3.5f));
        TransformGroup pillarTG = new TransformGroup();
        pillarTG.setTransform(Offset7);
        pillarTG.addChild(object3D[16].position_Object());
        
        // pillar 2
        Transform3D Offset8 = new Transform3D();
        Offset8.setTranslation(new Vector3f(-2.4f, 0f, -3.5f));
        TransformGroup pillar2TG = new TransformGroup();
        pillar2TG.setTransform(Offset8);
        pillar2TG.addChild(object3D[15].position_Object());
        
        
        leftWallTG.addChild(pillarTG);
        leftWallTG.addChild(pillar2TG);
